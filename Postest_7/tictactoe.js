...
function myfunc() { 
    const seluruhCel = document.querySelectorAll('.cell');
...
function myfunc_2() { 
    ...
    flag = 1;
    const seluruhTombol = document.querySelectorAll('.cell');
...
function myfunc_11() { 
    ...
    tombolReset.addEventListener('click', aturUlangPermainan);
    tombolDarkMode.addEventListener('click', toggleDarkMode);

    aturStatusPermainan();

    const seluruhCel = document.querySelectorAll('.cell');
    seluruhCel.forEach((cel, index) => {
        cel.addEventListener('click', () => handleKlik(index));
    });
}